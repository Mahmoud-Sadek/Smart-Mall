...
public class CartCategoryAdapter extends RecyclerView.Adapter<CartCategoryAdapter.OrdersVh> {

    Context context;
    List<Category> categoryList;
//    OrderFragmentPresenter orderFragmentPresenter;

    public CartCategoryAdapter(Context context, List<Category> categoryList) {
...
//        this.orderFragmentPresenter = orderFragmentPresenter;
    ...
    public OrdersVh onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.item_category_cart, parent, false);

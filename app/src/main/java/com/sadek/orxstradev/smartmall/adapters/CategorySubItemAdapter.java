...
public class CategorySubItemAdapter extends RecyclerView.Adapter<CategorySubItemAdapter.OrdersVh> {

    Context context;
    List<CategoryApiResponse.DataEntity> categoryList;

    public CategorySubItemAdapter(Context context, List<CategoryApiResponse.DataEntity> categoryList) {
    ...
    public OrdersVh onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.item_category_sub_item, parent, false);

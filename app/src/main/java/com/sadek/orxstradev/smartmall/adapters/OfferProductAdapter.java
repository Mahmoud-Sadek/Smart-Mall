...
public class OfferProductAdapter extends RecyclerView.Adapter<OfferProductAdapter.OrdersVh> {

    Context context;
    List<ProductApiResponse.DataEntity> productList;

    public OfferProductAdapter(Context context, List<ProductApiResponse.DataEntity> productList) {
